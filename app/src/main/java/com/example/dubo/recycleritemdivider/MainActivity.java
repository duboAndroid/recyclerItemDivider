package com.example.dubo.recycleritemdivider;
...
import views.GridItemDecoration;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.addItemDecoration(new GridItemDecoration(this.getResources().getDrawable(R.drawable.divider)));
    }
